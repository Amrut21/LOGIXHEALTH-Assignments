...
ADD HashedPassword VARBINARY(40);

UPDATE tbl_Login
SET HashedPassword = HASHBYTES('MD2', Password);
...
EXEC SP_RENAME 'tbl_login.HashedPassword','Password','Column'
...
--7)Getting ResturantName by FoodName
...
AS
BEGIN
SELECT @RestaurantName = rt.RestaurantName FROM dbo.tbl_Restaurant rt JOIN dbo.tbl_FoodItems fi on rt.RestaurantId=fi.RestaurantId
...
INSERT INTO @TAB 
SELECT 18,'Amruta','Iavalli',18,'BRUNCH' UNION ALL
...
SELECT dbo.fn_toLogin ('Ankur123', 'Ankur1523$')
